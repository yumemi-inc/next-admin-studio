...
import { useArtworkFormOperationState } from "../../../../store/hook";
...
export const useCancelTemporaryCloseArtwork = () => {
  const { loading, disabled, startOperation } = useArtworkFormOperationState(

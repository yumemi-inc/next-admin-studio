...
ignore: []
questions:
  property: 'プロパティ名を入力してください (eg. category)'
  required:
    confirm: '公開時 必須項目ですか？'
    initial: true
---
...
export const {{ name | snake | upper }}_DEFAULT_VALUE: string | null = null;
```
...
export type {{ model | pascal }}{{ inputs.property | pascal }}Slice = {
  {{ inputs.property | camel }}: string | null;
  set{{ inputs.property | pascal }}: ({{ inputs.property | camel }}: string | null) => void;
...
export const {{ model | pascal }}{{ inputs.property | pascal }}PreviewView = ({ value }: { value: string | null }) => {
